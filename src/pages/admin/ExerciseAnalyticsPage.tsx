...
import { ArrowLeft, TrendingDown, Users, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">Exercise Analytics</h1>
          <p className="text-xs text-gray-500 mt-0.5">Pass rates sorted by hardest first</p>
        </div>
      </div>
